...
//    console.log(burger, "working")
  ...
  return (
         <div >
            <div id={show?styles.togglebutton : styles.toggleinvisible} onClick={handlehamburger}>
            <span className={styles.hamburgertoggle}></span>
            <span className={styles.hamburgertoggle}></span>
            <span className={styles.hamburgertoggle}></span>
            </div>
        <div style={{display:burger ||window.innerWidth>=950?'block':show?'none': ""}}  className={styles.sidebarmaindiv}>
         ...
         <div className={styles.buttonandquestion}>
            <div> <button className={styles.sidetopbutton}>Upgrade to Premium</button>
            </div>
           <AiFillQuestionCircle color="#ec008c"
            size={22}
          ...
          />
            ...
            {data.map((item,index)=> (
                 ...
                 <Menudata lefticon={item.lefticon} title={item.title} righticon={item.righticon}/>            
                 </div>
            ))}
      </div>
      </div>
